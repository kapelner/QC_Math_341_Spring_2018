...
\title{MATH 341 / 650.3 Spring 2018 Homework \#4}

\author{Professor Adam Kapelner} %STUDENTS: write your name here

\iftoggle{professormode}{
\date{Due Friday 11:59PM, April 13, 2018 under the door of KY604 \\ \vspace{0.5cm} \small (this document last updated \today ~at \currenttime)}
}
...
Reading is still \textit{required}. For this homework set, review the Gamma-Poisson and Normal-Normal models and read the relevant sections of McGrayne. 
