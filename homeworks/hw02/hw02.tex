...
\date{Due Friday 5PM, March 2, 2018 under the door of KY604 \\ \vspace{0.5cm} \small (this document last updated \today ~at \currenttime)}
}
...
\easysubproblem{Why is your answer to (z) a smaller interval than (x)?}\spc{3}
