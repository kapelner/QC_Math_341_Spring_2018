...
\newcommand{\coursewebpage}{\href{https://github.com/kapelner/QC_Math_341_Spring_2018}{course homepage}}

\newcommand{\qu}[1]{``#1''}


\title{MATH 341 Spring 2018 (3 credits) \\ Course Syllabus}
...
Lecture Time / Loc & Monday and Wednesday 9:15 - 10:30AM / Kiely 326 \\
Office Hours / Loc & Monday and Wednesday 3:35-4:30PM  / Kiely 604 (my office) \\
Course Homepage & \href{https://github.com/kapelner/QC_Math_341_Spring_2018}{https://github.com/kapelner/QC\_Math\_341\_Spring\_2018} \\
\end{tabular}
\end{table}
...
\paragraph{Textbook:} Introduction to Bayesian Statistics by William M. Bolstad First Edition. It can be purchased used on \href{http://www.amazon.com/gp/offer-listing/0471270202/ref=sr_1_2_twi_1_har_olp?ie=UTF8&qid=1433515305&sr=8-2&keywords=introduction+to+bayesian+statistics+bolstad}{Amazon}. This is \textit{recommended}. ton get a way to get ``another take'' on the material. However, most of the material in the class comes from the lecture notes.  %We will also be using Bayesian Methods in Finance by by Svetlozar T. Rachev, John S. J. Hsu, Biliana S. Bagasheva  and Frank J. Fabozzi (First Edition) which can be bought on \href{http://www.amazon.com/gp/product/0471920835/ref=ox_sc_sfl_title_1?ie=UTF8&psc=1&smid=A1Q1B6W57NND6W}{Amazon}. 
...
\begin{itemize}
\item You have \emph{one week only} from the time of the lecture to email me lecture notes (or until the end of semester 5/16/18).
...
Late homework will be penalized 10 points per business day (Monday--Friday save holidays) for a maximum of five days. \textit{Do not ask for extensions}; just hand in the homework late. After five days, \textbf{you can hand it in whenever you want} until Monday, May 21, 2018 at noon. As far as I know, this is one of the most lenient and flexible homework policies in college. I realize things come up. Do not abuse this policy; you will fall far, far behind.
...
\begin{itemize}
\itemsep -0.0em 
\item Midterm examination I will be Monday, March 5 in class with the first review session on the Wednesday prior
\item Midterm examination II will be Wednesday, April 18 in class with a review on the Monday prior
\item The final examination will be Wednesday, May 23 8:30-10:30AM in KY326 with a review on the prior Wednesday, May 16.
\end{itemize}
